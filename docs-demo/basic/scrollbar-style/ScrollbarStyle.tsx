...
export default function ScrollbarStyle() {
    ...
    const columns: StkTableColumn<any>[] = [
        { type: 'seq', dataIndex: '' as any, title: t('seq'), width: 50 },
    ...
    return (
        <div>
            <style>{`
                .scrollbar.light { --scrollbar-thumb-color: #b0b0b0; --scrollbar-thumb-hover-color: #888; }
                .scrollbar.dark { --scrollbar-thumb-color: #393838; --scrollbar-thumb-hover-color: #555; }
                .scrollbar::-webkit-scrollbar { width: 8px; height: 8px; }
                .scrollbar::-webkit-scrollbar-thumb { border-radius: 4px; border: 2px solid transparent; box-shadow: inset 0 0 0 4px var(--scrollbar-thumb-color); }
                .scrollbar::-webkit-scrollbar-thumb:hover { box-shadow: inset 0 0 0 4px var(--scrollbar-thumb-hover-color); }
