...
export const enConfig = defineConfig({
    title: 'StkTableSolid',
    description: 'A high-performance virtual table for SolidJS',
    lang: 'en',
    themeConfig: {
        ...
        nav: [
            ...
            { text: 'Demos', link: '/en/demos/huge-data' },
            {
                text: 'Other Versions',
                items: [
                    { text: 'Vue', link: 'https://ja-plus.github.io/stk-table-vue/' },
        ...
        socialLinks: [{ icon: 'github', link: 'https://github.com/ja-plus/stk-table-solid' }],
        footer: {
