...
## demo
<demo solid="basic/row-cell-mouse-event/RowCellHoverSelect.tsx" github="https://github.com/ja-plus/stk-table-solid/tree/master/docs-demo/basic/row-cell-mouse-event/RowCellHoverSelect.tsx"></demo>
