...
<demo solid="advanced/auto-height-virtual/AutoHeightVirtual/index.tsx" github="https://github.com/ja-plus/stk-table-solid/tree/master/docs-demo/advanced/auto-height-virtual/AutoHeightVirtual/index.tsx"></demo>
...
## 単数列リスト
[可変高さ - 仮想単数列リスト](/ja/demos/virtual-list.html#Variable%20Height) を参照してください。
...
1. `autoRowHeight` と `virtual` を有効にする
2. `prepare` と `layout` メソッドを使用してテキストの高さを計算
3. `setAutoHeight(rowKey, height)` で実際の行の高さを設定

### 例

<demo solid="advanced/auto-height-virtual/PretextAutoHeight/index.tsx" github="https://github.com/ja-plus/stk-table-solid/tree/master/docs-demo/advanced/auto-height-virtual/PretextAutoHeight/index.tsx"></demo>
...
| パラメータ | 型 | 説明 |
| --- | --- | --- |
| rowKey | `string \| number` | 行の一意の識別子。`rowKey`に対応 |
| height | `number` | 行の高さ |
